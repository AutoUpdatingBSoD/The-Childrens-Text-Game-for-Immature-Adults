...
A FOSS Parody of Children's text games (such as the Kindercomp (Commorodore Vic-20) minigame Names in Lights).

This game is designed for the adults who exploited these games with immature word choices growing up, and maybe still do so.

This simplistic tech demo is a test case for future games to be written in Godot Engine.

This particular game was designed with GDScript, and will potentially move to FOSS C# for performance reasons.
